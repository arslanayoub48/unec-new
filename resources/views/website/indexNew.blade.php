                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-6">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <span>Fakültə</span>
                                                <p class="card-text"><a href="#">UNEC regionda iqtisad elmini dərindən
                                                        öyrədən fundamental
                                                        tədris
                                                        mərkəzidir.</a>
                                                </p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="title">
                            <h2>Elanlar</h2>
                            <span class="d-none d-lg-block">Bütün elanlar</span>
                        </div>
                        <div class="card-group">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-12">
                                            <div class="card">
                                                <img class="card-img-top"
                                                     ...
                                                     alt="Card image cap">
                                                <div class="card-body">
                                                    <h5 class="card-text"><a href="#">UNEC regionda iqtisad elmini
                    ...
                    <div class="col-lg-4">
                        <div class="tad">
                            <div class="title">
                                <h2>Tədbirlər</h2>
                                <span class="d-none d-lg-block">Bütün tədbirlər</span>
                            </div>
                            <ul>
                                <li>
                                    <div class="date">
                                    ...
                                    <div class="content">
                                        <p>UNEC regionda iqtisad elmini dərindən öyrədən fundamental tədris mərkəzidir.
                                        </p>
